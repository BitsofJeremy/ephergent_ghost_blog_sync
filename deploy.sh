...
# Deployment script for ephergent_ghost_blog_sync

# Exit immediately if a command exits with a non-zero status
set -e

# Configuration
APP_DIR="/opt/ephergent_ghost_blog_sync"
VENV_DIR="$APP_DIR/venv"
GITHUB_REPO="https://github.com/BitsofJeremy/ephergent_ghost_blog_sync.git"
BRANCH="main"
USER_NAME="jeremy"
